...
class GoogleSDK extends ThirdOauth
{
    /**
     * 获取requestCode的api接口
     * @var string
     ...
     * @var srting
     */
    protected $Authorize = 'scope=https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/youtube.readonly https://www.googleapis.com/auth/youtube.upload';
    ...
    protected $ThirdLoginType = 'YTBLOGIN';

    /**
     * 组装接口调用参数 并调用接口
     * @param  string $api    谷歌API
    ...
    public function call($api, $param = '', $method = 'GET', $multi = false){
        ...
        $data = $this->curlHttp($this->url($api), $this->param($params, $param), $method, $header);
